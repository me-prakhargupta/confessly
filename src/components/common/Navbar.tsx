  ...
  return (
    <nav className="relative bg-zinc-950 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 sm:px-10 py-4 flex items-center justify-between">
        <div className="text-white font-semibold tracking-tight">Confessly</div>
        <Link href="/accounts/signin" className="relative inline-flex items-center justify-center px-7 py-2 rounded-full bg-zinc-950 text-white font-semibold border border-orange-400/40 text-sm sm:text-base overflow-hidden transition-colors hover:bg-zinc-900">
